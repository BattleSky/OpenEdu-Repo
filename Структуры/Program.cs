...
/*
 * Структурам выделяются память в месте объявления.
 * Так структура может быть объявлена в стеке и в куче.
 * В куче выделяется память для хранения объекта целиком (непрерывный кусок памяти)
 */
